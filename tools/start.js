// Run all the development start scripts to build, start, and watch the application
...
async function start() {
	...
	function checkForUpdate(fromUpdate) {
		...
		if (!app.hot) throw new Error(`${hmrPrefix}Hot Module Replacement is disabled.`);
		...
		return app.hot
			...
			.catch(error => {
				...
				} else console.warn(`${hmrPrefix}Update failed: ${error.stack || error.message}`);
			});
	}
